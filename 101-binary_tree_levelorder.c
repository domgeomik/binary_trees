...
/**
 * binary_tree_depth - Depth of node Specified from Root
...
/**
 * linked_node - this function make a link list from Depth level and node
...
/**
 * recursion - goes around complete tree and each stores each node
